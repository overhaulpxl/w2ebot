...
ENABLE_ALL_ECONOMY = _env_bool("ENABLE_ALL_ECONOMY", False)
ECONOMY_V1_ENABLED = True if ENABLE_ALL_ECONOMY else _env_bool("ECONOMY_V1_ENABLED", False)
ECONOMY_PHASE2_ENABLED = True if ENABLE_ALL_ECONOMY else _env_bool("ECONOMY_PHASE2_ENABLED", False)
ECONOMY_PHASE3_ENABLED = True if ENABLE_ALL_ECONOMY else _env_bool("ECONOMY_PHASE3_ENABLED", False)
ECONOMY_PHASE4_ENABLED = True if ENABLE_ALL_ECONOMY else _env_bool("ECONOMY_PHASE4_ENABLED", False)
ECONOMY_PHASE5_ENABLED = True if ENABLE_ALL_ECONOMY else _env_bool("ECONOMY_PHASE5_ENABLED", False)
ECONOMY_PHASE6_ENABLED = True if ENABLE_ALL_ECONOMY else _env_bool("ECONOMY_PHASE6_ENABLED", False)
ECONOMY_PHASE7_ENABLED = True if ENABLE_ALL_ECONOMY else _env_bool("ECONOMY_PHASE7_ENABLED", False)
ECONOMY_PHASE8_ENABLED = True if ENABLE_ALL_ECONOMY else _env_bool("ECONOMY_PHASE8_ENABLED", False)
DASHBOARD_PUBLIC_URL = os.getenv("DASHBOARD_PUBLIC_URL", "").strip().rstrip("/")
DASHBOARD_DISCORD_CLIENT_ID = os.getenv("DASHBOARD_DISCORD_CLIENT_ID", "").strip()
DASHBOARD_DISCORD_CLIENT_SECRET = os.getenv("DASHBOARD_DISCORD_CLIENT_SECRET", "").strip()
DASHBOARD_INTERNAL_KEY_ID = os.getenv("DASHBOARD_INTERNAL_KEY_ID", "").strip()
DASHBOARD_INTERNAL_SIGNING_KEY = os.getenv("DASHBOARD_INTERNAL_SIGNING_KEY", "").strip()
DASHBOARD_SESSION_KEY_ID = os.getenv("DASHBOARD_SESSION_KEY_ID", "").strip()
DASHBOARD_SESSION_HASH_KEY = os.getenv("DASHBOARD_SESSION_HASH_KEY", "").strip()
DASHBOARD_IP_HASH_KEY = os.getenv("DASHBOARD_IP_HASH_KEY", "").strip()
...
def validate_startup_configuration(config=None, *, verify_database=True):
    ...
    if config.economy_phase7_enabled and not (
